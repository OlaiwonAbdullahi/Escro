        ...
        <div className="grid gap-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                defaultValue="TechHub Electronics"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                defaultValue="Quality Electronics, Trusted Service"
                className="h-11 border-gray-300 focus:border-emerald-500 focus:ring-emerald-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              defaultValue="We are a leading electronics retailer offering premium products at competitive prices. Our mission is to provide customers with the latest technology and exceptional customer service."
              className="min-h-[100px] border-gray-300 focus:border-emerald-500 focus:ring-emerald-500"
            />
            <p className="text-xs text-gray-500">
              This description will appear on your store&apos;s public page.
            </p>
          </div>
        </div>
      </div>
